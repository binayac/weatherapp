<?php
$apiKey = 'ea034a0aa96d41c030f1f99a0a52411e'; // Your OpenWeatherMap API key

// Get the city name from the query string
$city = isset($_GET['city']) ? $_GET['city'] : 'New York'; // Default to New York if not provided
...
if ($data) {
    ...
    $conn = new mysqli('127.0.0.1', 'root', '', 'weatherapp'); // Replace with your database credentials
